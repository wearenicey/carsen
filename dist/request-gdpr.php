...
$subject = 'Trainings Request CIPP/E and CIPM';
...
try {
    ...
    $emailTextHtml = "<h2>New training request for CIPP/E and CIPM</h2><hr>";
    $emailTextHtml .= "<table>";
    ...
    $mail->Subject = 'Trainings Request - CIPP/E and CIPM';
    ...
    if ($newMail->send()) {
        header('Location: trainings/gdpr-ready-combined-cipp-e-and-cipm-training.php?msg=success&ex=y');
    } else {
        header('Location: trainings/gdpr-ready-combined-cipp-e-and-cipm-training.php?msg=fail');
    }
} catch (Exception $e) {
