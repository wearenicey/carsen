...
$subject = 'New message from Training form';
...
try {
    ...
    //Recipients
    $mail->setFrom('info@carsen.se', 'Carsen Trainings Contact');
    $mail->addAddress('office@carsen.se', 'Carsen Contact');     // Add a recipient

    $mail->addReplyTo('office@carsen.se', 'Carsen Office');

    $emailTextHtml = "<h2>You have a new message from your Trainings form</h2><hr>";
    $emailTextHtml .= "<table>";
