...
$subject = 'Trainings Request CIPP/E';
...
try {
    ...
    $mail->Subject = 'Trainings Request - CIPP/E ';
    ...
    $newMail->setFrom('info@carsen.se', 'Carsen Trainings');
    ...
    if ($newMail->send()) {
        header('Location: trainings/certified-information-privacy-professional-europe-cipp-e-training.php?msg=success&ex=y');
    } else {
        header('Location: trainings/certified-information-privacy-professional-europe-cipp-e-training.php?msg=fail');
    }
} catch (Exception $e) {
